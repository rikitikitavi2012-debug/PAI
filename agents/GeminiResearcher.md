...
curl -X POST http://localhost:8888/notify \
  ...
  -d '{"message":"Исследователь Gemini загружает контекст","voice_id":"pNInz6obpgDQGcFmaJgB","title":"Alex Rivera"}'
```
...
curl -X POST http://localhost:8888/notify \
  -H "Content-Type: application/json" \
  -d '{"message":"Ваше сообщение о завершении здесь","voice_id":"pNInz6obpgDQGcFmaJgB","title":"Alex Rivera"}'
```
