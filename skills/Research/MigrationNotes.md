...
- **Destination:** `${CLAUDE_SKILL_DIR}/Workflows/ClaudeResearch.md`
- **Size:** 3.6K
...
- **Destination:** `${CLAUDE_SKILL_DIR}/Workflows/PerplexityResearch.md`
- **Size:** 8.1K
...
- **Destination:** `${CLAUDE_SKILL_DIR}/Workflows/InterviewResearch.md`
- **Size:** 4.4K
...
- **Destination:** `${CLAUDE_SKILL_DIR}/Workflows/AnalyzeAiTrends.md`
- **Size:** 3.0K
...
**Location:** `${CLAUDE_SKILL_DIR}/Workflows/`
