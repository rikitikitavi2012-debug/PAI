...
```bash
# Create new use case
bun run ${CLAUDE_SKILL_DIR}/EvalServer/cli.ts use-case create --name <name>

# List all use cases
bun run ${CLAUDE_SKILL_DIR}/EvalServer/cli.ts use-case list
...
bun run ${CLAUDE_SKILL_DIR}/EvalServer/cli.ts test-case add --use-case <name>

# List test cases for use case
bun run ${CLAUDE_SKILL_DIR}/EvalServer/cli.ts test-case list --use-case <name>
```
...
bun run ${CLAUDE_SKILL_DIR}/EvalServer/cli-run.ts --use-case <name> [--model <model>]
```
