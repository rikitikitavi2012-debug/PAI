...
**What They Do:**
- `WorkCompletionLearning.hook.ts` - Reads current work state and work directory metadata, captures significant work completions as learnings, saves to `MEMORY/LEARNING/`
...
- Writes to `~/.claude/MEMORY/LEARNING/SIGNALS/ratings.jsonl`
...
**Status:** Production - 22 hooks active across 6 event types
