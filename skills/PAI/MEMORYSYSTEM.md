...
- `WorkCompletionLearning.hook.ts` on SessionEnd (captures significant work completions as learnings)
...
2. `SessionEnd` → WorkCompletionLearning updates item with response summary + captures ISC
