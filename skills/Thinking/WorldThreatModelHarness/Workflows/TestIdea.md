...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Тестирую вашу идею против одиннадцати моделей мировых угроз на уровне TIER", "voice_id": "ogi2DyUAKJb7CEdqqvlU"}'
```
...
curl -s -X POST http://localhost:8888/notify \
  -H "Content-Type: application/json" \
  -d '{"message": "Анализ завершён. SUMMARY_OF_EXECUTIVE_VERDICT", "voice_id": "ogi2DyUAKJb7CEdqqvlU"}'
```
