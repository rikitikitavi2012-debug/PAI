...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Запускаю TechnicalCreativityGemini3 в скилле BeCreative для generate technical solutions"}' \
  > /dev/null 2>&1 &
```
...
1. Load workflow: `read ${CLAUDE_SKILL_DIR}/Workflows/TechnicalCreativityGemini3.md`
