...
1. **PAI hardening** — TELOS обновлён, скиллы G10 к аудиту, community PRs на review
2. **Сайт Timber Frame** — выбор стека, контент-план, MVP (сезон начинается в апреле!)
3. **Цифровой Прораб** — синхронизация SyncEngine + Telegram дайджест
4. **Земля Былым** — связаться с агентствами в Тырныаузе
