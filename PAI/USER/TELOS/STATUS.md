...
**Текущий фокус:** PAI Kitty Workspace → Timber Frame сайт (система → продукт → независимость)
...
1. **PAI Kitty Workspace** — довести TUI до рабочего состояния: все табы, визуальная верификация, UX
2. **Timber Frame сайт** — следующий шаг после системы: выбор стека, MVP, контент от Шульца → G1 → M0

**НЕ в фокусе (параллельно, не отвлекать):**
- Цифровой Прораб (G0) — задача для фирмы/прорабов, не требует внимания Ivan
- Community PRs — ждут ответа, пинг по готовности
- Бригада/тестирование — фоновые процессы Jules/A0
