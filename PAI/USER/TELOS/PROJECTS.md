...
**Статус:** MVP LIVE — timber-frame-spb.ru задеплоен, ещё не принимает заявки, реклама не настроенна, сео на раскрутке первые статьи, сайт задеплоен 08.03.2026 г.
...
- [ ] Страница /navesy (108 показов/мес)
- [ ] Расширение слабых статей (score 73-77)
- [ ] ФЗ-152: политика конфиденциальности + регистрация оператора ПД
- [ ] Фото: продукция + команда (контент от Шульца)
- [ ] Timeweb Cloud PostgreSQL (РФ серверы, ФЗ-152)
- [ ] Первая рекламная кампания Яндекс.Директ
...
**P1 — MVP задеплоен.** Фокус сместился на конверсию и рекламу:
1. **ФЗ-152 compliance** — политика конфиденциальности, регистрация ПД (до запуска рекламы)
2. **Фото на сайт** — контент от Шульца (критично для конверсии)
3. **Яндекс.Директ** — API токена получен, затем первая кампания к апрелю
4. **P3 (Цифровой Прораб)** — SyncEngine + Telegram дайджест (вечерами)
