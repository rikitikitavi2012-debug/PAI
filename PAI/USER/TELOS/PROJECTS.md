...
**Хостинг:** Vercel → **Cloudflare Proxy** (защита от РКН, 30 мин настройка) → **Coolify на VPS** (декабрь, межсезонье, ~800₽/мес). Исследование 4 агентов: Amvera (170-4300₽), Coolify (600-1200₽), Yandex Cloud (холодный старт 1-10с), Cloudflare (бесплатно). Выбор: двухэтапная миграция.
...
- [x] **Хостинг исследование (2026-04-01):** 4 агента исследовали Amvera/Coolify/Yandex Cloud/Cloudflare. Вердикт: Cloudflare Proxy сейчас (защита от РКН, бесплатно) → Coolify на VPS в декабре (~800₽/мес, полная независимость)
...
**Следующие шаги:**
- [ ] **Cloudflare Proxy** — защита от РКН (30 мин, бесплатно) — СЕГОДНЯ
