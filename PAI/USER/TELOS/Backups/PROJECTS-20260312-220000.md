...
**Статус:** MVP LIVE + ВИЗУАЛ ГОТОВ — timber-frame-spb.ru задеплоен 08.03.2026. Портфолио полностью визуализировано (21 WebP, 5 диаграмм). Ревизия: визуал закрыт, контент усилен KB экспертизой. Ещё не принимает заявки, реклама не настроена.
