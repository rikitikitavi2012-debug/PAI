...
- **Quality over count** — Hitting the ISC floor by padding with trivial criteria ("file exists", "no typos in filename") is compliance theater. Each criterion must represent a genuinely independent verifiable sub-requirement. If you can't find enough real criteria, the task is simpler than the tier suggests — consider downshifting effort level rather than inflating the count.
