...
function createElectricBanner(stats: SystemStats, width: number): string {
  ...
  const infoLines = [
    ...
    `${P.neonBlue}${SYM.target}${RESET} ${P.glow}OS${RESET}         ${P.electric}PAI ${stats.paiVersion}${RESET}`,
...
function createTealBanner(stats: SystemStats, width: number): string {
  ...
  const infoLines = [
    ...
    `${P.mediumTeal}${SYM.wave}${RESET} ${P.paleAqua}OS${RESET}         ${P.aquamarine}PAI ${stats.paiVersion}${RESET}`,
...
function createIceBanner(stats: SystemStats, width: number): string {
  ...
  const infoLines = [
    ...
    `${P.iceBlue}${SYM.crystal}${RESET} ${P.frost}OS${RESET}         ${P.white}PAI ${stats.paiVersion}${RESET}`,
...
function createNavyCompactBanner(stats: SystemStats, width: number): string {
  ...
  const infoLines = [
    ...
    `${C.navy}\u2B22${RESET} ${C.slate}PAI${RESET} ${C.silver}${stats.paiVersion}${RESET} ${C.navy}\u2699${RESET} ${C.silver}${stats.algorithmVersion}${RESET}`,
...
function createNavyUltraCompactBanner(stats: SystemStats, width: number): string {
  ...
  lines.push(center(`${C.lightBlue}${stats.name}${RESET}${C.slate}@pai ${stats.paiVersion}${RESET} ${C.navy}\u2699${RESET}${C.silver}${stats.algorithmVersion}${RESET}`, width));
