---
prd: true
id: PRD-20260312-0-exasynergy-skill-ent
title: "А0 выявил у себя проблему в exa-synergy skill имеет баг (entity_types) — нужен"
session_id: "unknown"
status: ACTIVE
mode: interactive
...
# А0 выявил у себя проблему в exa-synergy skill имеет баг (entity_types) — нужен
...
### Problem Space
А0 выявил у себя проблему в exa-synergy skill имеет баг (entity_types) — нужен ремонт для будущих research задач
...
- 2026-03-11T22:45:10.145Z | CREATED | STANDARD effort | 8-16 ISC target
