---
prd: true
id: PRD-20260219-api-error-403-errortypeforbiddenm
status: DRAFT
mode: interactive
...
# API Error 403 errortypeforbiddenm
...
### Problem Space
что за ошибка API Error: 403 {"error":{"type":"forbidden","message":"Request not allowed"}} · Please run /login
