...
# что это в низу на дашбоде за кнопка на нее нажимаш
...
### Problem Space
что это в низу на дашбоде за кнопка на нее нажимашь и выподает меню и там какие то 3 Issues что это такое
