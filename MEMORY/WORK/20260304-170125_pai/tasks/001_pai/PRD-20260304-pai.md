...
prd: true
id: PRD-20260304-pai
title: "Продолжаем над китти ворспейс PAI таб телос, экран внизу не могу прокрутить"
session_id: "unknown"
status: ACTIVE
mode: interactive
...
# Продолжаем над китти ворспейс PAI таб телос, экран внизу не могу прокрутить
...
### Problem Space
продолжаем над китти ворспейс PAI таб телос, экран внизу не могу прокрутить вверх сразу сбрасывает в низ
...
- 2026-03-04T14:01:25.861Z | CREATED | STANDARD effort | 8-16 ISC target
