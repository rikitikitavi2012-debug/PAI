...
prd: true
id: PRD-20260304-4
title: "4 таб телеметрия не появился при перезапуске китти"
session_id: "unknown"
status: ACTIVE
mode: interactive
...
# 4 таб телеметрия не появился при перезапуске китти
...
- 2026-03-04T14:49:50.171Z | CREATED | STANDARD effort | 8-16 ISC target
